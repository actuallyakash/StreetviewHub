...
@section('title', "Placeholder Images from Google Street View | StreetviewHub")
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-12 col-md-5 col-lg-6 banner-image text-center">
                    <img class="banner-image img-fluid shadow rounded-lg" src="https://streetviewhub.com/shots" alt="streetviewhub-placeholder">
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-9 col-sm-12 docs shadow-sm">
                <div class="docs-section mt-5" id="introduction">
                    ...
                    <p>Images are explored by people on StreetviewHub using Google Street View. All the images are from Google Street View and StreetviewHub is not affiliated with Google.</p>
                ...
                <div class="docs-section" id="size">
                    ...
                    <pre><code><a href="https://streetviewhub.com/shots/400x300">https://streetviewhub.com/shots/400x300</a></code></pre>
                    <p>Get the square image by</p>
                    <pre><code><a href="https://streetviewhub.com/shots/400/">https://streetviewhub.com/shots/400/</a></code></pre>
                </div>
                ...
                <div class="docs-section" id="search">
                    ...
                    <pre><code><a href="https://streetviewhub.com/shots?q=nature">https://streetviewhub.com/shots?q=nature</a></code></pre>
                    <p>For searching more than one word, just <strong>concatenate (+)</strong> them.</p>
                    <pre><code><a href="https://streetviewhub.com/shots/400x200?q=burj+khalifa">https://streetviewhub.com/shots/400x200?q=burj+khalifa</a></code></pre>
                </div>
                ...
                <div class="docs-section" id="imageById">
                    ...
                    <pre><code><a href="https://streetviewhub.com/feed?id=true">https://streetviewhub.com/feed?id=true</a></code></pre>
                    <p>The above parameter will enable the ID on any page.</p>
                    <p>And use the ID in the placeholder URL.</p>
                    <pre><code><a href="https://streetviewhub.com/shots?image={IMAGEID}">https://streetviewhub.com/shots?image={IMAGEID}</a></code></pre>
                ...
                <div class="docs-section" id="randomImage">
                    ...
                    <pre><code><a href="https://streetviewhub.com/shots">https://streetviewhub.com/shots</a></code></pre>
                </div>
                ...
                <div class="docs-section" id="grayscale">
                    ...
                    <pre><code><a href="https://streetviewhub.com/shots?grayscale=1">https://streetviewhub.com/shots?grayscale=1</a></code></pre>
                </div>

                <div class="docs-section" id="blur">
                    <h2 class="docs-title">Blur</h2>
                    <p>Get a blurred out image by adding <kbd>?blur=1</kbd> parameter</p>
                    <pre><code><a href="https://streetviewhub.com/shots?blur=1">https://streetviewhub.com/shots?blur=1</a></code></pre>
                </div>
                ...
                <div class="docs-section" id="grayscale-blur">
                    ...
                    <pre><code><a href="https://streetviewhub.com/shots?blur=1&grayscale=1">https://streetviewhub.com/shots?blur=1&grayscale=1</a></code></pre>
                </div>
                ...
                <div class="docs-section" id="imageByProfile">
                    ...
                    <pre><code><a href="https://streetviewhub.com/shots?u=streetviewhub">https://streetviewhub.com/shots?u=streetviewhub</a></code></pre>
                </div>

                <div class="docs-section" id="more-options">
                    <h2 class="docs-title">More</h2>
                    <p>More options coming soon. Until then keep <a href="https://streetviewhub.com">exploring</a> 🌏</p>
                    <p>Found a typo? Have ideas? Wanna contribute? StreetviewHub and it's API is <a href="https://github.com/actuallyakash/streetviewhub">Open Source</a>.</p>
                    <pre><code><a href="https://streetviewhub.com">https://streetviewhub.com</a></code></pre>
